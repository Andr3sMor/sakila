...
# --- CONFIGURACIÓN ---
s3 = boto3.client('s3')
bucket_input = 'sakila-rds-customers'  # Ajusta si es otro bucket
prefix_input = 'fact_rental/'  # Carpeta donde están los archivos con fechas
...
def main():
    ...
    # --- LIMPIEZA Y EXTRACCIÓN DE FECHAS ---
    ...
    # Crear DataFrame con todas las fechas únicas
